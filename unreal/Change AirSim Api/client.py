...
#basic flight control
    ...
    def simSwitchDronesLight(self, light_name):
        """
        Change intensity of named light
        ...
        Returns:
            bool: True if successful, otherwise False
        """
        return self.client.call("simSwitchDronesLight", light_name)

    def simSetLightColor1(self, light_name):
        """
        Change intensity of named light
        ...
        Returns:
            bool: True if successful, otherwise False
        """
        return self.client.call("simSetLightColor1", light_name)
    ...
    def simSetLightColor2(self, light_name):
        """
        Change intensity of named light
        ...
        Returns:
            bool: True if successful, otherwise False
        """
        return self.client.call("simSetLightColor2", light_name)
    
    def simSetLightColor3(self, light_name):
        """
        Change intensity of named light
        ...
        Returns:
            bool: True if successful, otherwise False
        """
        return self.client.call("simSetLightColor3", light_name)

    def simSetLightColor4(self, light_name):
        """
        Change intensity of named light
        ...
        Returns:
            bool: True if successful, otherwise False
        """
        return self.client.call("simSetLightColor4", light_name)

    def simBatteryDead(self, light_name):
        """
        Change intensity of named light
        ...
        Returns:
            bool: True if successful, otherwise False
        """
        return self.client.call("simBatteryDead", light_name)
