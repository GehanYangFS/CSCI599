...
namespace airlib
{
    ...
    public:
        ...
        virtual bool switchDronesLight(const std::string& light_name) = 0;
        virtual bool setLightColor1(const std::string& light_name) = 0;
        virtual bool setLightColor2(const std::string& light_name) = 0;
        virtual bool setLightColor3(const std::string& light_name) = 0;
        virtual bool setLightColor4(const std::string& light_name) = 0;
        virtual bool setBatteryDead(const std::string& light_name) = 0;
