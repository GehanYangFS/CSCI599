...
bool WorldSimApi::setLightColor1(const std::string& light_name)
{
    bool result = false;
    UAirBlueprintLib::RunCommandOnGameThread([this, &light_name, &result]() {
        AActor* light_actor = simmode_->scene_object_map.FindRef(FString(light_name.c_str()));
        ...
        if (light_actor) {
            const FString command = FString::Printf(TEXT("SetLight1"));
            FOutputDeviceNull ar;
            result = light_actor->CallFunctionByNameWithArguments(*command, ar, nullptr, true);
        }
    },
...
bool WorldSimApi::setLightColor2(const std::string& light_name)
{
    bool result = false;
    UAirBlueprintLib::RunCommandOnGameThread([this, &light_name, &result]() {
        AActor* light_actor = simmode_->scene_object_map.FindRef(FString(light_name.c_str()));
        ...
        if (light_actor) {
            const FString command = FString::Printf(TEXT("SetLight2"));
            FOutputDeviceNull ar;
            result = light_actor->CallFunctionByNameWithArguments(*command, ar, nullptr, true);
        }
    },
...
bool WorldSimApi::setLightColor3(const std::string& light_name)
{
    bool result = false;
    UAirBlueprintLib::RunCommandOnGameThread([this, &light_name, &result]() {
        AActor* light_actor = simmode_->scene_object_map.FindRef(FString(light_name.c_str()));
        ...
        if (light_actor) {
            const FString command = FString::Printf(TEXT("SetLight3"));
            FOutputDeviceNull ar;
            result = light_actor->CallFunctionByNameWithArguments(*command, ar, nullptr, true);
        }
    },
...
bool WorldSimApi::setLightColor4(const std::string& light_name)
{
    bool result = false;
    UAirBlueprintLib::RunCommandOnGameThread([this, &light_name, &result]() {
        AActor* light_actor = simmode_->scene_object_map.FindRef(FString(light_name.c_str()));
        ...
        if (light_actor) {
            const FString command = FString::Printf(TEXT("SetLight4"));
            FOutputDeviceNull ar;
            result = light_actor->CallFunctionByNameWithArguments(*command, ar, nullptr, true);
        }
    },
...
bool WorldSimApi::setBatteryDead(const std::string& light_name)
{
    bool result = false;
    UAirBlueprintLib::RunCommandOnGameThread([this, &light_name, &result]() {
        AActor* light_actor = simmode_->scene_object_map.FindRef(FString(light_name.c_str()));
        ...
        if (light_actor) {
            const FString command = FString::Printf(TEXT("BatteryDead"));
            FOutputDeviceNull ar;
            result = light_actor->CallFunctionByNameWithArguments(*command, ar, nullptr, true);
        }
    },
