...
public:
    ...
    virtual bool switchDronesLight(const std::string& light_name);
    virtual bool setLightColor1(const std::string& light_name);
    virtual bool setLightColor2(const std::string& light_name);
    virtual bool setLightColor3(const std::string& light_name);
    virtual bool setLightColor4(const std::string& light_name);
    virtual bool setBatteryDead(const std::string& light_name);
